# mecp2_h2aub_mch/mecp2_h2aub_mch_v2.R
#
...
#
# Upstream dependency: adult_mecp2_vs_h2aub/adult_MeCP2vsH2AUb_v2.R
#   must be run first to produce gene_level_results_v2.csv
#
# Input:
#   adult_mecp2_vs_h2aub/gene_level_results_v2.csv
#   results/03_differential/mch_differential_results.tsv
#   mecp2_h2aub_mch/gencode.vM25.mouse.genes.annotation.bed
...
gene_df <- read_csv(
  here("adult_mecp2_vs_h2aub", "gene_level_results_v2.csv"),
